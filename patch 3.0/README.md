...
2- Place [keep-out-argent](url) under the ```modules``` folder of your core source folder.
...
Re-run Cmake, compile & restart your server completely after you have completed the steps.
